...
class EditUserProfile extends Component {
  ...
  async deleteClient() {
    try {
      ...
      toast.success("✔️ Client Deleted Susseccfully !", {
        position: "top-right",
        autoClose: 3000,
  ...
  async postData() {
    try {
      ...
      console.log("Result: " + result);
      toast.success("✔️ Client Details Updated Susseccfully !", {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
  ...
  componentDidMount() {
    let selectedUserID = sessionStorage.getItem("activeUserID:");
          ...
          <div className="col-lg-12 mt-5">
            <div className="card">
              <div className="card-body">
                <div>
                  <h4 className="header-title">Edit Client Profile</h4>
                </div>
